...
export default function App() {
  ...
  return (
    <>
      <div className="relative flex flex-col items-center justify-evenly  h-screen bg-[url('/bg7.jpeg')] bg-cover bg-right bg-no-repeat sm:bg-cover overflow-none px-2">
